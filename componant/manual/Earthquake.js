    ...
    return (
        ...
        <ScrollView>
          ...
          <Text style={styles.postDescription}>
              <Text style = {{fontWeight : 'bold'}}>ข้อควรปฏิบัติ ขณะเกิดแผ่นดินไหว</Text> {"\n"}
          ...
          <Tooltip
            ...
            >  
              <View style={styles.pictureView}>
                <Image style={styles.picture}
                  source={require('../../assets/manual/Earthquake2.png')}/>
              </View>
          </Tooltip>

          <Text style={styles.postDescription}>
            <Text style = {{fontWeight : 'bold'}}>ข้อควรปฏิบัติ หลังเกิดแผ่นดินไหว</Text> {"\n"}
