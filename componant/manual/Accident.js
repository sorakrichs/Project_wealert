    ...
    return (
        ...
        <Tooltip
          ...
          <View style={styles.postContent}>
              ...
              <Text style = {{fontWeight : 'bold'}}>1.หยุดรถ</Text> {"\n"}
              ...
              <Text style = {{fontWeight : 'bold'}}>2.อย่าพูดพล่อย</Text> {"\n"}
              ...
              <Text style = {{fontWeight : 'bold'}}>5.แจ้งตำรวจ</Text> {"\n"}
              ...
              <Text style = {{fontWeight : 'bold'}}>6.หาพยาน</Text> {"\n"}
          ...
          <View style = {styles.borderButton}>
              <OpenURLButton url={supportedURL}><Text style={{fontSize:18}}>บทความอ้างอิง</Text></OpenURLButton>
            </View>
        </View>
    )
}
